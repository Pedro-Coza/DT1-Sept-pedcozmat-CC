...
@Service
public class AnonymousBullletinCreateService implements AbstractCreateService<Anonymous, Bulletin> {
	...
	public Bulletin instantiate(final Request<Bulletin> request) {
		...
		result = new Bulletin();
		result.setAuthor("PedroCozaMateos");
		result.setText("First bulletin from instantiate");
