...
@Service
public class EnterpreneurApplicationListByCreationDateService implements AbstractListService<Enterpreneur, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findManyByCreationDate(principal.getActiveRoleId());
