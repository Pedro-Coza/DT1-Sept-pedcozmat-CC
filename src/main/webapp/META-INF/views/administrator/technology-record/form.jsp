...
<acme:message code="administrator.technologyRecord.h2" />

<acme:menu-separator />

<acme:form>
	<acme:form-textbox code="administrator.technologyRecord.form.label.title" path="title"/>
	<acme:form-textbox code="administrator.technologyRecord.form.label.sector" path="activitySector"/>
	<acme:form-textbox code="administrator.technologyRecord.form.label.investorName" path="investorName"/>
	...
	<acme:form-textbox code="administrator.technologyRecord.form.label.rating" path="rating"/>
