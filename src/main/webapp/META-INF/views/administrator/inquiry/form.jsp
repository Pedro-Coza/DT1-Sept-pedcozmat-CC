...
<acme:message code="administrator.inquiry.h2" />
...
<acme:form>
	...
	<acme:form-money code="administrator.inquiry.form.label.mmax" path="mmin"/>
	<acme:form-money code="administrator.inquiry.form.label.mmin" path="mmax"/>
